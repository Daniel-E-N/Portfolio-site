---
title: "Hospital Bed Remote"
summary: "Redesigning LINAK's hospital bed remote so senior citizens can adjust their own beds — bigger tactility, clearer layout, fewer functions, more agency."
year: 2024
collaborator: "LINAK"
...
snapshot:
  problem: "Hospital bed remotes are designed for caregivers, not residents. Arthritis, low vision, and unfamiliar technology keep senior citizens from adjusting their own beds — while care homes face a future with fewer hands to help."
  approach: "A three-week sprint with LINAK: desk research on impairments, fieldwork in two care homes, wide sketching, hands-on physical prototypes, and stress-testing under simulated impairments — ski gloves on, eyes closed."
  outcome: "A remote seniors can find, hold, and operate on their own: large high-contrast rocker buttons, a grippable waist, and only the functions residents actually need — delivered as a 3D-printed, testable model."
gallery:
  - src: "./assets/render-side.webp"
    alt: "Side view render of the redesigned remote"
  - src: "./assets/render-buttons.webp"
    alt: "Render highlighting the remote's high-contrast buttons"
  - src: "./assets/ui-concept-1.webp"
    alt: "Concept exploration of the button layout"
  - src: "./assets/render-front.webp"
    alt: "Front view of the final remote design"
---

## Challenge

<p class="section-claim">give residents back the controls</p>
...
<p class="section-claim">mapping grip, sight, and memory barriers</p>
...
![Research overview mapping impairments and existing remote solutions](./assets/desk-research.webp)

*The impairment map became our checklist: every design decision had to pass all four barriers.*

## Fieldwork

<p class="section-claim">in care homes, simplicity wins</p>
...
![Interview notes and photos from the care home visits](./assets/fieldwork.jpeg)

*Field notes from the care home visits — the recliner remote observation changed the project's direction.*

## Sketching

<p class="section-claim">wide before narrowing</p>
...
![Pages of sketches exploring shapes, layouts, and button types](./assets/sketching.webp)
![Detailed sketch exploring button placement and grip](./assets/sketch-detail.webp)

*From broad shape studies to detailed button and grip explorations.*

## Prototyping

<p class="section-claim">objects you can hold beat renders</p>
...
![Foam and cardboard prototypes of different remote shapes](./assets/prototyping.webp)

*Foam and cardboard made every idea testable within hours.*

## Testing

<p class="section-claim">ski gloves and closed eyes</p>
...
![A participant testing a prototype while wearing ski gloves](./assets/testing.webp)

*If you can operate it in ski gloves with your eyes closed, arthritis and low vision won't stop you.*

## CAD & print

<p class="section-claim">into someone's hand</p>
...
![CAD screenshot of the remote model in progress](./assets/cad-screen-1.webp)
![CAD screenshot showing the button layout detail](./assets/cad-screen-2.webp)
...
![The 3D printed remote held in a hand](./assets/printed-in-hand.jpeg)
