---
title: "Focus Lamp"
summary: "A desk lamp that keeps you in flow: set a session length with a twist, and the light gradually dims as your time runs out — no phone required."
year: 2024
role: "Concept, prototyping, 3D CAD"
tags: ["Autoethnography", "Prototyping", "3D CAD", "Work in progress"]
theme: "teal"
order: 4
type: "case"
...
gallery:
  - src: "./assets/render-lamp-1.webp"
    alt: "Render of the egg-shaped Focus Lamp, front view"
  - src: "./assets/render-lamp-2.webp"
    alt: "Render of the Focus Lamp glowing"
  - src: "./assets/render-lamp-3.png"
    alt: "Render of the Focus Lamp from above"
  - src: "./assets/render-lamp-4.png"
    alt: "Render showing the lamp's twist-to-set base"
---
...
![Clay pottery work from the three-week autoethnographic study](./assets/research-pottery.jpeg)
...
![Concept sketches of the timer lamp](./assets/sketches.jpeg)
...
![The laser-cut cardboard prototype of the lamp](./assets/prototype.webp)
...
![The prototype lamp being tested](./assets/testing.webp)
...
![CAD model of the Focus Lamp](./assets/cad-model.jpeg)
...
![Render of the Focus Lamp concept](./assets/final-render.webp)
